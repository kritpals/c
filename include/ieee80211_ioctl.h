...
enum {
    ...
    IEEE80211_PARAM_SET_ISOLATION = 354,
};
/*
...
typedef enum {
    ...
    IEEE80211_WLANCONFIG_HW_GET_CHANLIST,
    IEEE80211_WLANCONFIG_ADD_MAC,
    IEEE80211_WLANCONFIG_SHOW_MAC,
    IEEE80211_WLANCONFIG_DEAUTH_STA,
    IEEE80211_WLANCONFIG_ROAM_RSSI_THRESHOLD,
    IEEE80211_WLANCONFIG_ROAM_LIFE_TICKS,
    IEEE80211_WLANCONFIG_ROAM_NUM_OF_RSSIS,
} IEEE80211_WLANCONFIG_CMDTYPE;
struct ieee80211_hw_channel_list {
    int hw_mode;
    int nchans;
    int hw_channel_list[IEEE80211_CHAN_MAX];
    int hw_freq_list[IEEE80211_CHAN_MAX];
};
#define IEEE80211_ROAM_MAX_NUM_OF_MACS 128
struct ieee80211_roam_list {
    int num;
    u_int8_t macs[IEEE80211_ROAM_MAX_NUM_OF_MACS][IEEE80211_ADDR_LEN];
    int rssi[IEEE80211_ROAM_MAX_NUM_OF_MACS];
    int8_t ticks[IEEE80211_ROAM_MAX_NUM_OF_MACS];
    int8_t local_ticks[IEEE80211_ROAM_MAX_NUM_OF_MACS];
};

struct ieee80211_macaddr {
    u_int8_t mac[IEEE80211_ADDR_LEN];
    u_int8_t bssid[IEEE80211_ADDR_LEN];
};

struct ieee80211_roam_params {
    u_int8_t roam_rssi_threshold;
    u_int16_t roam_life_ticks;
    u_int8_t roam_num_of_rssis;
};
...
struct ieee80211_wlanconfig {
    ...
    union {
        ...
        struct ieee80211_hw_channel_list hw_channels;
        struct ieee80211_macaddr wc_addr;
        struct ieee80211_roam_params roam_params;
    } data;
