...
*For any further query email me @ kritpal.sing@gmail.com
 Originally created for Mediatek SDK 
  TCP Syn port scanner code in C with Linux Sockets using raw socket to check ICMP packets.
    /opt/buildroot-gcc463/usr/bin/mipsel-linux-g++ tcp_scan.c -o tscan -lpthread -w ; cp tscan /tftpboot/
 */
...
int main(int argc, char *argv[]) {
    ...
    char source_ip[20] = "192.168.1.1";
    //get_local_ip( source_ip );
    getIfIp("br0", source_ip);
